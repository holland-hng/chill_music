...
import '../screen/library/bloc/library_bloc.dart' as _i15;
import '../screen/library/bloc/library_repository.dart' as _i14;
import '../screen/library/bloc/track_repository.dart' as _i17;
import '../screen/login/bloc/auth_bloc.dart' as _i6;
import '../screen/login/bloc/auth_repository.dart' as _i7;
import '../screen/playlist/bloc/playlist_bloc.dart' as _i16;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i15.LibraryBloc>(
      () => _i15.LibraryBloc(get<_i14.LibraryRepository>()));
  gh.factory<_i16.PlayListBloc>(
      () => _i16.PlayListBloc(get<_i10.PlaylistRepository>()));
  ...
  gh.singleton<_i17.TrackRepository>(_i17.TrackRepository());
  gh.singleton<_i14.LibraryRepository>(
      _i14.LibraryRepository(get<_i17.TrackRepository>()));
  return get;
}
